...
INSERT IGNORE INTO `grant` (name, description, amount, legal_text, auto_accept, accept_days)
VALUES
...
INSERT IGNORE INTO participant (name, email, phone, address)
VALUES
...
INSERT IGNORE INTO agreement (status, created_at, grant_id, participant_id)
VALUES
